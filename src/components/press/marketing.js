...
export default function Marketing({ frontend, backend }) {
  ...
  return (
    ...
    >
      ...
      {
        field === "frontend" && (
          <div className="w-full  flex flex-wrap justify-center gap-[30px] max-sm:gap-10 p-[100px] max-sm:p-0 min-h-[50vh]" >
            {
              frontend.map((item, index) => (
                <div className=" max-sm:w-full w-[400px] h-[500px] bg-white/5 hover:bg-white/10 flex flex-col py-[30px] px-[10px] items-center justify-center rounded-[20px] backdrop-blur-sm" >
      ...
      {
        field === "backend" && (
          <div className="w-full  flex flex-wrap justify-center gap-[30px] max-sm:gap-10 max-sm:p-0 p-[100px] min-h-[50vh]" >
            {
