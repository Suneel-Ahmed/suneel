  ...
  return (
    <div className="w-full h-full flex flex-col lg:flex-row place-content-center lg:place-content-between place-items-center">
      <div className="w-full h-full absolute inset-0">
		...
		{alt ? (
  <div className="w-[90vw] lg:w-[62vw] aspect-square absolute top-1/2 left-0 lg:right-0 -translate-x-[75%] lg:translate-x-[75%] -translate-y-1/2 rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,rgba(239,220,249,0.2)_0%,rgba(239,220,249,0)_100%)] blur-[125px]" />
) : (
  <div className="w-[90vw] lg:w-[62vw] aspect-square absolute top-1/2 left-0 -translate-x-[75%] -translate-y-1/2 rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,rgba(239,220,249,0.2)_0%,rgba(239,220,249,0)_100%)] blur-[125px]" />
)}
      ...
      >
        <p className="text-outlined text-transparent text-[clamp(60px,8vw,140px)]  text-left font-hvdTrialGraphit font-bold leading-[100%]">
