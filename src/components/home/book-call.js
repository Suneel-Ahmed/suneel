...
export default function BookCall() {
  ...
  return (
    <section
      id="book-a-call"
      className="book-call-section w-full my-[20px]  lg:mb-[200px]   h-auto lg:h-screen px-[8vw] lg:px-[clamp(40px,4vw,75px)] lg:pt-[16vh] relative flex flex-col place-content-center place-items-center z-[50]"
    >
     ...
     Schedule Call
      ...
      <div className="block w-full  max-sm:mt-[20px] mt-[50px] ">
       <section
                ...
                >
    <div className="w-[70%] max-sm:w-[100%] min-h-screen overflow-hidden relative">
        <InlineWidget
