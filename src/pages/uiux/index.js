...
export default index;
  ...
  export async function getServerSideProps() {
    const urls = [
      `${process.env.NEXT_PUBLIC_BACKEND_API}/uiux-hero?populate=*`,
      `${process.env.NEXT_PUBLIC_BACKEND_API}/uiux-sec2?populate=*`,
      `${process.env.NEXT_PUBLIC_BACKEND_API}/brand-strategy-uiux-developments?populate=*`,
      `${process.env.NEXT_PUBLIC_BACKEND_API}/uiux-sec3?populate=*`,
      `${process.env.NEXT_PUBLIC_BACKEND_API}/uiux-sec4?populate=*`,
      `${process.env.NEXT_PUBLIC_BACKEND_API}/brand-strategy-uiux-sec4s?populate=*`,
    ...
    try {
      ...
      const isAllOk = responses.every(res => res.ok);
      if (!isAllOk) {
